...
### N3: Orca's per-agent account management (the assistant accounts, Codex accounts, Gemini accounts, etc.)
...
| Orca has account management for the assistant, Codex, Gemini, etc. | [read their code] — `src/main/cloud-model/`, `src/main/codex-accounts/`, `src/main/gemini/`, `src/main/cloud-model/` directories exist |

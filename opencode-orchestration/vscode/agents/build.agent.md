---
name: build
description: Primary execution agent. Implements features using the currently validated sglang-backed OpenAI-compatible coding alias from the platform registry (coder-main), then runs quality gates before handoff.
...
- Canonical behavior lives in the repo OpenCode surface.
- `vscode/agents/` mirrors the OpenCode contract; it does not redefine it.

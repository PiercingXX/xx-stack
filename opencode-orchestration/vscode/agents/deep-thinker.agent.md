---
name: deep-thinker
description: Deep reasoning specialist. Produces decision-grade architecture, risk, and optimization plans using the validated TurboQuant-backed reasoning lane and self-hosted fallbacks.
...
- Canonical reasoning policy lives in the repo OpenCode agent surface.

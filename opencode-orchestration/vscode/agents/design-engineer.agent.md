...
- Design workflow behavior lives in repo assets and canonical `packs/design/workflow-skills/*/SKILL.md` files.
- This VS Code agent mirrors that behavior; it should not invent a separate design contract.
...
3. **Pick a workflow skill** — read `packs/design/workflow-skills/<skill>/SKILL.md` + `assets/template.html` + `references/layouts.md`

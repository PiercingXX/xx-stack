...
Use the repo OpenCode surface as canonical when definitions disagree.

- `opencode/agents/` and `opencode/skills/` define the behavior contract
- `vscode/agents/` and `vscode/skills/` are mirrors and adapters

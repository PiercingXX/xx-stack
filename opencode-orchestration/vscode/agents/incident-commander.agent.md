...
description: Incident response lead. Coordinates triage, containment, rollback, and postmortem using the sglang-backed OpenAI-compatible lanes and validated fallbacks.

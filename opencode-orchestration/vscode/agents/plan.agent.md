---
name: plan
description: Primary planning agent. Deep analysis and architecture trade-offs using the currently validated sglang-backed OpenAI-compatible coding alias from the platform registry (coder-main). Produces an executable plan package.
...
- Canonical behavior lives in the repo OpenCode planning surface.
- This VS Code mirror adapts that contract; it does not replace it.

---
name: "reasoning-fast"
description: "Lower-latency reasoning lane for medium-complexity planning tasks using the primary sglang-backed OpenAI-compatible alias and validated fallbacks."
tools:
  - codebase
  - readFile
  - runCommands

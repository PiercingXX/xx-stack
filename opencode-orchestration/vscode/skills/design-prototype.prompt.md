...
- canonical design workflow behavior lives in repo assets and `packs/design/workflow-skills/*/SKILL.md`
...
### Step 3 — Pick a skill
Read the matching SKILL.md from `packs/design/workflow-skills/`:
...
- Compatibility shim: `opencode/skills/design/`

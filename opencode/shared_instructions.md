...
1. active runtime override configured by the host (`.opencode/` install, user prompt override, or equivalent)
2. repo canonical definition in `opencode/agents/<name>.md`
3. repo adapter mirror in `vscode/agents/<name>.agent.md`
...
2. repo canonical skill at `opencode/skills/<name>/SKILL.md`
3. repo adapter mirror at `vscode/skills/<name>.prompt.md`

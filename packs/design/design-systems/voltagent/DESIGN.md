...
- Nav structure: Logo → Product dropdown → Use Cases dropdown → Resources dropdown → community badge → Docs CTA
- Link text: Snow White (`#f2f2f2`) at 14–16px Inter, weight 500
- Hover: links transition to green variants (`#00c182` or `#00ffaa`)
- Community badge: social proof element integrated directly into nav
...
**Community Section**
- Large community icon as the visual anchor

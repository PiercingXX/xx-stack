...
Things to notice:
- The `od:` front-matter block is optional for cloud-model compatibility, but adding it lights up OD's typed inputs, sliders, preview metadata, and capability gating.

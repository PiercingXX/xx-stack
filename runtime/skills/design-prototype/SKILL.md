...
This skill is part of stack core, but it consumes the design content pack (`packs/design/design-systems/`, `packs/design/design-skills/`, `packs/design/runtime/skills/design/`, and `packs/design/DESIGN-CATALOG.md`) as input.
...
Navigate to `packs/design/runtime/skills/design/<skill-name>/` and read:
...
packs/design/runtime/skills/design/  ← canonical workflow skills (prototype/deck/document)

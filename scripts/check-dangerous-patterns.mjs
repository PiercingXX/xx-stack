 ...
 *
 * Canonical file: runtime/dangerous-patterns.txt (one POSIX-ERE per
...
//   sha256sum runtime/dangerous-patterns.txt
const EXPECTED_SHA256 = "ff837204f3b86bac525fe78f1c6fa27b339a65130c7485ff3e870d0b8c5e1b7d";
  ...
  if (!mirrorOk) {
    failures.push(
      `opencode mirror does not resolve to the canonical file: ${mirrorPath}\n` +
        `      Expected a symlink to ../../runtime/dangerous-patterns.txt`
    );
  }
}

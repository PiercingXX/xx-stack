...
process.stderr.write(
  "[xx-stack] WARNING: headless OpenCode execution is experimental and unreliable in current builds.\n" +
  "[xx-stack] The preflight check will fail fast if the transport cannot complete a tool loop.\n" +
  "[xx-stack] For unattended production use, prefer a runner with a proven headless transport.\n" +
  "[xx-stack] See README.md § Autonomous Todo Loop for details.\n\n"
);

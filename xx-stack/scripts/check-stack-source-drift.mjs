...
const CONTENT_PAIRS = [
  ...
  {
    // The VS Code slash-command prompt surfaces. Hand-maintained on BOTH sides
    // (unlike adapters/agents, which is generated by sync-vscode-agents.mjs),
    // so this pair is the only thing standing between them and silent drift.
    label: "vscode-skill-prompts",
    canonicalDir: "xx-stack/adapters/skills",
    mirrorDir: "opencode-orchestration/vscode/skills",
...
const KNOWN_DELTAS = [
  {
    file: "*",
    why: "Each prompt names the host surface it adapts to; the xx-stack adapter surface is host-agnostic.",
    canonical: ["- adapter prompt mirrors adapt that contract to this surface"],
    mirror: ["- VS Code prompt mirrors adapt that contract to this surface"],
  },
  {
    file: "*",
    why: "Second phrasing of the same line; the prompt set is not internally consistent about how it words it.",
    canonical: ["- mirror prompts adapt that contract to this adapter surface"],
    mirror: ["- mirror prompts adapt that contract to the VS Code surface"],
  },
  {
    file: "xx-stack/runtime/skills/diagnose-stack/SKILL.md",
    why: "The diagnostic names the surface it is diagnosing: generic 'runtime' vs OpenCode.",
    canonical: [
      "- Are there any same-name mirror agents in <<mirror>>/agents that materially disagree with the canonical runtime definitions?",
    ],
    mirror: [
      "- Are there any same-name mirror agents in <<mirror>>/agents that materially disagree with the canonical OpenCode definitions?",
    ],
  },
  {
    file: "xx-stack/runtime/skills/diagnose-stack/SKILL.md",
    why: "Same: names the host mirror surface being diagnosed ('adapter' vs 'vscode').",
    canonical: ["- Do any adapter skill mirrors exist without a canonical repo SKILL.md?"],
    mirror: ["- Do any vscode skill mirrors exist without a canonical repo SKILL.md?"],
  },
  {
    file: "xx-stack/runtime/skills/diagnose-stack/SKILL.md",
    why: "Section heading for the same check on each host surface.",
    canonical: ["### 5. Adapter wiring"],
    mirror: ["### 5. VS Code wiring"],
  },
  {
    file: "xx-stack/runtime/skills/diagnose-stack/SKILL.md",
    why: "Same heading, in the report template table.",
    canonical: ["| Adapter wiring | PASS | Mirrors present and consistent |"],
    mirror: ["| VS Code wiring | PASS | Mirrors present and consistent |"],
  },
  {
    file: "xx-stack/runtime/skills/diagnose-stack/SKILL.md",
    why: "Same: names the host mirror surface being diagnosed.",
    canonical: [
...
const MIN_CONTENT_FILE_PAIRS = 55;

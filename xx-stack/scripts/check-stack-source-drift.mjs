...
const KNOWN_DELTAS = [
  {
    file: "xx-stack/runtime/skills/research-deep/SKILL.md",
  ...
  {
    file: "xx-stack/runtime/skills/review-code/SKILL.md",
  ...
  {
    file: "xx-stack/runtime/agents/parallel-execution-orchestrator.md",
  ...
  {
    file: "xx-stack/runtime/TELEMETRY-POLICY.md",
